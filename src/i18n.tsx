...
const es = {
  ...
  featured: {
    ...
    momentum: {
      kicker: 'FULL-STACK · WEB + ANDROID',
      titleLine1: 'Momentum',
      titleLine2: 'Entrenamiento inteligente',
      desc: 'Plataforma multideporte para registrar fuerza, carrera y ciclismo, unificar la carga de entrenamiento y visualizar riesgo, progreso y récords personales.',
      stat1Value: '3',
      stat1Note: 'disciplinas conectadas',
      stat2Value: 'ACWR',
      stat2Note: 'riesgo de carga',
      stat3Value: 'GPS',
      stat3Note: 'registro en Android',
      caption: 'Fuerza · Carrera · Ciclismo',
...
const en: typeof es = {
  ...
  featured: {
    ...
    momentum: {
      kicker: 'FULL-STACK · WEB + ANDROID',
      titleLine1: 'Momentum',
      titleLine2: 'Training intelligence',
      desc: 'Multisport platform for logging strength, running and cycling, unifying training load, and visualizing risk, progress and personal records.',
      stat1Value: '3',
      stat1Note: 'connected disciplines',
      stat2Value: 'ACWR',
      stat2Note: 'load-risk tracking',
      stat3Value: 'GPS',
      stat3Note: 'Android recording',
      caption: 'Strength · Running · Cycling',
